...
<body class="vh-100">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-0 navbar-fixed-top">
        <div class="container">
                ...
                <div class="col-auto col-md-2 col-xl-2 px-sm-2 px-0 bg-dark navbar-fixed-top">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        <ul class="navbar-nav adminnav mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li class="nav-item">
                                <a href="/admin/addProduct" class="text-light align-middle px-0">
                                    <h4>
                                        <i class="far fa-plus-square px-3 pe-4"></i>
                                        <span class="ms-1 d-none d-sm-inline">
                                            Toevoegen product
                                        </span>
                                    </h4>
